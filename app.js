...
let eighth = "Pour cet algorithme, vous devez placer les différentes pièces noires ( p (pion), f (fou), d (dame), r (roi), t (tour), c (cavalier)) sur les cases présente de l'échiquier. Ensuite vous placerez le cavalier blanc (C (cavalier)). Vous verrez alors, si celui-ci est capable de capturer une pièce noire."
